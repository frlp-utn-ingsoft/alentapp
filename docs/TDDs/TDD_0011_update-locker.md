...
*   **Domain**: Entidad `Locker` y reglas de negocio asociadas a la modificación de casilleros: número obligatorio, número único, número mayor a cero, ubicación obligatoria, estado válido y asignación coherente del socio según el estado del casillero.
...
21. Agregar prueba de error por estado inválido.
22. Agregar prueba de error al asignar un socio a un casillero en mantenimiento.
23. Agregar prueba de error cuando `status` es `Assigned` y no se envía `member_id`.
