    ...
    <Box>
      ...
      <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} gap="8">
        ...
        <SectionCard 
          ...
          description="Gestioná los certificados de aptitud física de los socios, su vigencia y estado de validación."
        ...
        <SectionCard
          title="Sanciones"
          description="Gestiona sanciones disciplinarias, períodos de suspensión y restricciones de socios."
          to="/disciplines"
          icon={LuShieldAlert}
        />
        <SectionCard
          title="Deportes"
          description="Administra el catálogo de actividades deportivas, cupos, precios adicionales y requisitos médicos."
          to="/sports"
          icon={LuDumbbell}
        />
        <Box
