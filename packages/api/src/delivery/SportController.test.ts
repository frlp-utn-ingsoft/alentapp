...
describe('SportController', () => {
  ...
  describe('getAll', () => {
    it('debe devolver status 200 y la lista de deportes', async () => {
      const mockSports = [{ id: 'sport-1', name: 'Fútbol' }];
  ...
  describe('create', () => {
    it('debe devolver status 201 si la creación es exitosa', async () => {
      const mockSport = { id: 'sport-1', ...mockRequest.body };
    ...
    it('debe devolver status 409 si el nombre ya existe', async () => {
    ...
    it('debe devolver status 400 si el cupo es inválido', async () => {
      mockCreateUseCase.execute.mockRejectedValueOnce(new Error('El cupo máximo debe ser mayor a cero'));
  ...
  describe('update', () => {
    it('debe devolver status 200 si se actualiza correctamente', async () => {
      const mockSport = { id: 'sport-1', ...mockRequest.body, description: 'Nueva' };
  ...
  describe('delete', () => {
    ...
    it('debe devolver status 409 si el deporte tiene inscripciones', async () => {
      mockDeleteUseCase.execute.mockRejectedValueOnce(
        new Error('No se puede eliminar un deporte con inscripciones'),
      );
